  ...
  const styles =
    ...
    (cfg.paidOffStatus || cfg.paymentCalendar
      ? '.' +
        ...
        '.' +
        p +
        '-paid-date{display:block;font-size:11px;color:#64748b;margin-top:4px;}' +
        '.' +
        p +
