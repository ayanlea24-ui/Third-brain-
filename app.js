...
function buildCostPlannerWorkspaceHtml(cfg) {
  ...
  return (
    ...
    '</button>' +
    (tablePlanner
      ? '<span class="' + p + '-debt-actions-hint">Use <strong>Delete</strong> in the Actions column to remove a row.</span>'
      : '') +
    '</div>' +
    '<input type="hidden" id="' +
    p +
