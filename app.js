...
function buildCostPlannerWorkspaceHtml(cfg) {
  ...
  const script =
    ...
    'function debtActionsCell(isNew){if(!CFG.paidOffStatus)return "<td><button type=\\"button\\" class=\\""+P+"-debt-remove\\">Remove</button></td>";return "<td class=\\""+P+"-row-actions\\"><button type=\\"button\\" class=\\""+P+"-debt-edit\\" title=\\"Edit category\\" aria-label=\\"Edit category\\">"+(isNew?"Done":"Edit")+"</button><button type=\\"button\\" class=\\""+P+"-debt-remove\\" title=\\"Remove category\\" aria-label=\\"Remove category\\">Remove</button></td>";}' +
